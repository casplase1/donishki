...
const images =
  [
    ...
    {
      src: '/examples/5.jpg',
      thumbnail: '/examples/5.jpg',
      thumbnailWidth: 250,
      thumbnailHeight: 250,
    },
    {
      src: '/examples/6.jpg',
      thumbnail: '/examples/6.jpg',
      thumbnailWidth: 250,
      thumbnailHeight: 250,
    },
    {
      src: '/examples/7.jpg',
      thumbnail: '/examples/7.jpg',
      thumbnailWidth: 250,
      thumbnailHeight: 250,
    },
    {
      src: '/examples/8.jpg',
      thumbnail: '/examples/8.jpg',
      thumbnailWidth: 250,
      thumbnailHeight: 250,
    },
    {
      src: '/examples/9.jpg',
      thumbnail: '/examples/9.jpg',
      thumbnailWidth: 350,
      thumbnailHeight: 250,
    },
    {
      src: '/examples/10.jpg',
      thumbnail: '/examples/10.jpg',
      thumbnailWidth: 350,
      thumbnailHeight: 250,
    },
    {
      src: '/examples/12.jpg',
      thumbnail: '/examples/12.jpg',
      thumbnailWidth: 350,
      thumbnailHeight: 250,
    },
  ];
...
export default ({ handleWaypointEnter }) => (
  <Wrapper>
    <GalleryWrapper>
      ...
      <H2>Связанные донышки из пряжи</H2>
      <GalleryContent>
